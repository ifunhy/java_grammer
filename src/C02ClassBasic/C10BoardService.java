        ...
        while (true) {
            ...
            switch (str) {
                ...
                case "3": // id, email, name, password, 작성글 수(for문)
                    ...
                    System.out.println("회원 ID: " + found.getId());
                    System.out.println("회원 email: " + found.getEmail());
                    System.out.println("회원 name: " + found.getName());
                    System.out.println("회원 password: " + found.getPassword());
                    System.out.println("회원 작성글 수: " + found.getPostList().size());
                    break;
